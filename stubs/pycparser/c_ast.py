...
class ArrayDecl(Node):
    ...
    dim_quals: List[str]
    def __init__(self, type: Type, dim: Optional[Node], dim_quals: List[str], coord: Optional[Coord]=None): ...
...
class Assignment(Node):
    ...
    lvalue: Expression
    rvalue: Expression
    def __init__(self, op: str, lvalue: Expression, rvalue: Expression, coord: Optional[Coord]=None): ...
...
class Case(Node):
    ...
    def __init__(self, expr: Expression, stmts: List[Statement], coord: Optional[Coord]=None): ...

class Cast(Node):
    to_type: 'Typename'
    expr: Expression
    def __init__(self, to_type: 'Typename', expr: Expression, coord: Optional[Coord]=None): ...

class Compound(Node):
    block_items: Optional[List[Statement]]
    def __init__(self, block_items: Optional[List[Statement]], coord: Optional[Coord]=None): ...

class CompoundLiteral(Node):
    type: 'Typename'
    init: 'InitList'
    def __init__(self, type: 'Typename', init: 'InitList', coord: Optional[Coord]=None): ...
...
class DoWhile(Node):
    cond: Expression
    stmt: Statement
    def __init__(self, cond: Expression, stmt: Statement, coord: Optional[Coord]=None): ...
...
class Enum(Node):
    ...
    def __init__(self, name: Optional[str], values: 'EnumeratorList', coord: Optional[Coord]=None): ...

class Enumerator(Node):
    name: str
    value: Optional[Expression]
    def __init__(self, name: str, value: Optional[Expression], coord: Optional[Coord]=None): ...
...
class ExprList(Node):
    ...
    def __init__(self, exprs: List[Union_[Expression, Typename]], coord: Optional[Coord]=None): ...
...
class For(Node):
    ...
    stmt: Statement
    def __init__(self, init: Union_[None, Expression, DeclList], cond: Optional[Expression], next: Optional[Expression], stmt: Statement, coord: Optional[Coord]=None): ...

class FuncCall(Node):
    name: Expression
    args: Optional[ExprList]
    def __init__(self, name: Expression, args: Optional[ExprList], coord: Optional[Coord]=None): ...

class FuncDecl(Node):
    args: Optional[ParamList]
    type: Type # return type
    def __init__(self, args: Optional[ParamList], type: Type, coord: Optional[Coord]=None): ...

class FuncDef(Node):
    decl: Decl
    param_decls: Optional[List[Decl]]
    body: Compound
    def __init__(self, decl: Decl, param_decls: Optional[List[Decl]], body: Compound, coord: Optional[Coord]=None): ...
...
class If(Node):
    ...
    def __init__(self, cond: Expression, iftrue: Statement, iffalse: Optional[Statement], coord: Optional[Coord]=None): ...

class InitList(Node):
    exprs: List[Union_[Expression, 'NamedInitializer']]
    def __init__(self, exprs: List[Union_[Expression, 'NamedInitializer']], coord: Optional[Coord]=None): ...
...
class NamedInitializer(Node):
    ...
    expr: Expression
    def __init__(self, name: List[Expression], expr: Expression, coord: Optional[Coord]=None): ...

class ParamList(Node):
    params: List[Union_[Decl, ID, Typename, EllipsisParam]]
    def __init__(self, params: List[Union_[Decl, ID, Typename, EllipsisParam]], coord: Optional[Coord]=None): ...
...
class StructRef(Node):
    ...
    type: str
    field: ID
    def __init__(self, name: Expression, type: str, field: ID, coord: Optional[Coord]=None): ...
...
class TernaryOp(Node):
    ...
    iftrue: Expression
    iffalse: Expression
    def __init__(self, cond: Expression, iftrue: Expression, iffalse: Expression, coord: Optional[Coord]=None): ...

class TypeDecl(Node):
    declname: Optional[str]
    quals: List[str]
    type: InnerType
    def __init__(self, declname: Optional[str], quals: List[str], type: InnerType, coord: Optional[Coord]=None): ...
...
class Typedef(Node):
    ...
    storage: List[str]
    type: Type
    def __init__(self, name: str, quals: List[str], storage: List[str], type: Type, coord: Optional[Coord]=None): ...

class Typename(Node):
    name: None
    quals: List[str]
    type: Type
    def __init__(self, name: None, quals: List[str], type: Type, coord: Optional[Coord]=None): ...

class UnaryOp(Node):
    op: str
    expr: Union_[Expression, Typename]
    def __init__(self, op: str, expr: Union_[Expression, Typename], coord: Optional[Coord]=None): ...
